...
public class RenderCommand extends ConfiguredCommand<EastMarketConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<EastMarketConfiguration> bootstrap,
                       Namespace namespace,
                       EastMarketConfiguration configuration) throws Exception {
